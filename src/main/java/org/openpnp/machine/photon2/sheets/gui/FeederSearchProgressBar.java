...
public class FeederSearchProgressBar extends JPanel {
    ...
    private final Map<Integer, PhotonFeederTwo.FeederSearchState> feederSearchStateMap;
    ...
    protected void paintComponent(Graphics g) {
        ...
        for (int elementNumber = 0; elementNumber < numberOfElements; elementNumber++) {
            PhotonFeederTwo.FeederSearchState feederSearchState;
            feederSearchState = feederSearchStateMap.getOrDefault(elementNumber, PhotonFeederTwo.FeederSearchState.UNKNOWN);
    ...
    public void updateFeederState(int feederAddress, PhotonFeederTwo.FeederSearchState feederSearchState) {
