package org.openpnp.machine.photon2.sheets.gui;
...
import org.openpnp.machine.photon2.PhotonProperties;
import org.openpnp.machine.photon2.protocol.PhotonBusInterface;
import org.openpnp.machine.photon2.protocol.commands.ProgramFeederFloorAddress;
import org.openpnp.machine.photon2.protocol.commands.UninitializedFeedersRespond;
...
public class FeederSlotUpdateStep extends JPanel {
    ...
    public FeederSlotUpdateStep() {
        ...
        photonBus = PhotonFeederTwo.getBus();
        ...
        public void run() {
            while (!shouldStopThread) {
                try {
                    ...
                    PhotonFeederTwo feeder = new PhotonFeederTwo();
