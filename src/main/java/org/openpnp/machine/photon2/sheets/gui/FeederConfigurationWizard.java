...
public class FeederConfigurationWizard extends AbstractConfigurationWizard {
	 ...
	 * Create the panel.
	 */
	public FeederConfigurationWizard(PhotonFeederTwo feeder) {
		this.feeder = feeder;
		...
		panelVision.add(btnEditPipeline, "2, 2, left, center");
	...
	public void createBindings() {
		...
		AutoBinding<PhotonFeederTwo, Object, SlotProxy, Object> binding = Bindings.createAutoBinding(UpdateStrategy.READ,
...
//		bind(UpdateStrategy.READ, feeder, "slot", slotProxy, "slot");
	...
	private final Action editPipelineAction =
