package org.openpnp.machine.photon2.protocol.commands;

import org.openpnp.machine.photon2.protocol.Command;
import org.openpnp.machine.photon2.protocol.ErrorTypes;
import org.openpnp.machine.photon2.protocol.Packet;
import org.openpnp.machine.photon2.protocol.PacketBuilder;

public class GetFeederAddress extends Command<GetFeederAddress.Response> {
    public static final int COMMAND_ID = 0xC0;
    public static final int BROADCAST_ID = 0xff;
    private final String uuid;

    public GetFeederAddress(String uuid) {
        this.uuid = uuid;
    }
